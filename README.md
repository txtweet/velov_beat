...
`${GOPATH}/src/github.com/txtweet/velov_beat`
...
```
git remote set-url origin https://github.com/txtweet/velov_beat
...
in the same directory with the name velov_beat.
...
```
./velov_beat -c velov_beat.yml -e -d "*"
```
...
```
mkdir -p ${GOPATH}/src/github.com/txtweet/velov_beat
git clone https://github.com/txtweet/velov_beat ${GOPATH}/src/github.com/txtweet/velov_beat
```
